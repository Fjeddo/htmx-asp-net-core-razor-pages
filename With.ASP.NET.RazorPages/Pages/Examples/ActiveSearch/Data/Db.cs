namespace With.ASP.NET.RazorPages.Pages.Examples.ActiveSearch.Data;

public class Db
{
    public static Person[] Contacts { get; set; } = All.Contacts;
}
...
file static class All
{
    public static Person[] Contacts = System.Text.Json.JsonSerializer.Deserialize<Person[]>(
        """
        [
